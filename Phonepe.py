...
#For Aggregated Data
path1 = r"C:\Users\sony\Desktop\pulse\data\aggregated\transaction\country\india\state"
Agg_state_list = os.listdir(path1)


col1={'State':[], 'Year':[],'Quater':[],'Transaction_type':[], 'Transaction_count':[], 'Transaction_amount':[]}
...
path2 = r"C:\Users\sony\Desktop\pulse\data\aggregated\user\country\india\state"
...
#For Map Data
path3 = r"C:\Users\sony\Desktop\pulse\data\map\transaction\hover\country\india\state"
...
path4 = r"C:\Users\sony\Desktop\pulse\data\map\user\hover\country\india\state"
...
#For Top Data
path5 = r"C:\Users\sony\Desktop\pulse\data\top\transaction\country\india\state"
TOP_list = os.listdir(path5)

col5 = {'State': [], 'Year': [], 'Quater': [], 'District': [], 'Transaction_count': [], 'Transaction_amount': []}
for i in TOP_list:
    p_i = path5 + i + "/"
    Agg_yr = os.listdir(p_i)
...
path6 = r"C:\Users\sony\Desktop\pulse\data\top\user\country\india\state"
USER_list = os.listdir(path6)

col6 = {'State': [], 'Year': [], 'Quater': [], 'District': [], 'RegisteredUser': []}
for i in USER_list:
    p_i = path6 + i + "/"
    Agg_yr = os.listdir(p_i)
...
df_aggregated_transaction.to_sql('aggregated_transaction', mycon, if_exists='replace')
df_aggregated_user.to_sql('aggregated_user', mycon, if_exists='replace')
df_map_transaction.to_sql('map_transaction', mycon, if_exists='replace')
df_map_user.to_sql('map_user',mycon, if_exists='replace')
df_top_transaction.to_sql('top_transaction',mycon, if_exists='replace')
df_top_user.to_sql('top_user', mycon, if_exists='replace')

#App Page
SELECT = option_menu(
        menu_title = None,
        options = ["Home","About","Search","Basic insights"],
